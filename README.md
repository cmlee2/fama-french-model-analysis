...
After constructing the Data Pipeline, I used statsmodel and scikit learn to compare fit the ticker onto a linear regression. I utilized Time Series Splits to ensure the data I was feeding was model did not unintentionally skew scores positively.
